(() => {
  ...
  var y = document.querySelector("#facts"),
    b = document.querySelector("#factInput"),
    g = document.querySelector("#factsout");
  b.addEventListener("input", function () {
    var e = b.value;
    fetch("http://numbersapi.com/" + e)
      .then(function (e) {
        return e.text();
      })
      .then(function (t) {
        "" !== e && ((y.style.display = "block"), (g.innerHTML = t));
      })
      .catch(function (e) {
